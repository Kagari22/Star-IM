...
func (a *App) Router() http.Handler {
	...
	authPinMessage := handler.WithAuth(a.Config.JWTSecret, a.blacklist, a.messages.SetPinned)
	router.PUT("/api/messages/:id/pin", func(c *gin.Context) { c.Request.SetPathValue("id", c.Param("id")); authPinMessage(c.Writer, c.Request) })
	router.GET("/api/messages/pinned", gin.WrapF(handler.WithAuth(a.Config.JWTSecret, a.blacklist, a.messages.Pinned)))
